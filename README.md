...
**Required additional nodes (for sample workflows):**
...
- **[ComfyUI_ControlAltAI_Nodes](https://github.com/ussoewwin/ComfyUI_ControlAltAI_Nodes)** - Required for ControlNet features
